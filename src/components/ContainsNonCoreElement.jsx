...
const ContainsNonCoreElement = () => {
  ...
  useEffect(() => {
    ...
    session
      .run("MATCH p=()-[:CONTAINS_NON_CORE_ELEMENT]->() RETURN p LIMIT 25;")
      .then(result => {
        const graph = {
          nodes: [],
          links: [],
        ...
        result.records.forEach(record => {
          ...
          path.segments.forEach(segment => {
            ...
            const endNodeName = endNode.properties.name || "";
            ...
            graph.links.push({
              source: startNodeId,
              target: endNodeId,
              type: "CONTAINS_NON_CORE_ELEMENT",
            });
          });
        });
...
export default ContainsNonCoreElement;
